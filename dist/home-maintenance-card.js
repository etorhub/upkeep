...
`;let z=class extends y{constructor(){super(...arguments),this.progress=0,this.color="var(--primary-color)",this.size=48,this.strokeWidth=4}render(){const e=(this.size-this.strokeWidth)/2,t=2*Math.PI*e,r=Math.min(this.progress,100),i=t-r/100*t,s=this.size/2,n=Math.min(this.progress,999);return l`
    ...
    `}_renderList(e,t,r){const{task:i}=this,s=this.progressType==="bar";return l`
      <div
        class="tile list ${s?"list-bar":""} ${r?"overdue":""} ${this._done?"done-anim":""}"
      >
        <div class="list-row">
          ...
          ${s?f:l`<div class="list-progress">${this._renderProgress(e)}</div>`}
          <div class="list-action">${this._renderDoneButton()}</div>
        </div>
        ${s?l`<div class="list-bar-footer">${this._renderProgress(e)}</div>`:f}
      </div>
    ...
    `}};_([v({attribute:!1})],x.prototype,"hass",void 0),_([v({attribute:!1})],x.prototype,"task",void 0),_([v({type:String})],x.prototype,"progressType",void 0),_([v({type:String})],x.prototype,"viewMode",void 0),_([T()],x.prototype,"_confirming",void 0),_([T()],x.prototype,"_done",void 0),x=_([R("hm-task-tile")],x);let oe=class extends y{constructor(){super(...arguments),this.tasks=[]}render(){const e=this.tasks.filter(i=>i.urgency==="overdue").length,t=this.tasks.filter(i=>i.urgency==="due_soon").length,r=this.tasks.filter(i=>i.urgency==="on_track").length;return l`
      <div class="header">
        ${e>0?l`
    ...
    `}};_([v({attribute:!1})],oe.prototype,"tasks",void 0),oe=_([R("hm-summary-header")],oe),console.info(`%c HOME-MAINTENANCE-CARD 
%c ${d("common.version")} ${xt} `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:xe,name:"Home Maintenance Card",description:"Visual task tracker for the Home Maintenance integration with progress rings, auto-discovery, and one-tap completion.",preview:!0});let E=class extends y{constructor(){super(...arguments),this._activeFilter=g.filter}static async getConfigElement(){return await Promise.resolve().then(function(){return Zt}),document.createElement("home-maintenance-card-editor")}static getStubConfig(){return{title:g.title}}setConfig(e){if(!e)throw new Error(d("common.invalid_configuration"));this._config={...e},this._activeFilter=e.filter??g.filter}getCardSize(){return 3}shouldUpdate(e){if(e.has("_config")||e.has("_activeFilter"))return!0;if(!e.has("hass"))return!1;const t=e.get("hass");return t?we(this.hass,this._config.entities,this._config.exclude_entities).some(i=>t.states[i]!==this.hass.states[i]):!0}render(){if(!this.hass||!this._config)return l`
      ...
      <ha-card>
        ${u?l`
            ...
            `:f}
        <div class="card-content">
          ${a?l`<hm-summary-header .tasks=${s}></hm-summary-header>`:f}
          ${p?this._renderFilterBar():f}
          ${r.length===0?l`
                <div class="empty">
    ...
    `}_columns(){return this._config?.columns??3}};E.styles=Kt,_([v({attribute:!1})],E.prototype,"hass",void 0),_([T()],E.prototype,"_config",void 0),_([T()],E.prototype,"_activeFilter",void 0),E=_([R(xe)],E);var Je;(function(o){o.language="language",o.system="system",o.comma_decimal="comma_decimal",o.decimal_comma="decimal_comma",o.space_comma="space_comma",o.none="none"})(Je||(Je={}));var Ye;(function(o){o.language="language",o.system="system",o.am_pm="12",o.twenty_four="24"})(Ye||(Ye={}));const q=(o,e,t,r)=>{r=r||{},t=t??{};const i=new Event(e,{bubbles:r.bubbles===void 0?!0:r.bubbles,cancelable:!!r.cancelable,composed:r.composed===void 0?!0:r.composed});return i.detail=t,o.dispatchEvent(i),i};let P=class extends y{constructor(){super(...arguments),this._openSection="general"}setConfig(e){this._config={...e}}render(){return!this.hass||!this._config?l``:l`
    ...
    `}};_([v({attribute:!1})],P.prototype,"hass",void 0),_([T()],P.prototype,"_config",void 0),_([T()],P.prototype,"_openSection",void 0),P=_([R(wt)],P);var Zt=Object.freeze({__proto__:null,get HomeMaintenanceCardEditor(){return P}});export{E as HomeMaintenanceCard};
